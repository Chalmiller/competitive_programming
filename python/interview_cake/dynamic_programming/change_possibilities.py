...
def change_possibilities(amount, denominations):
    ...
    """
    Task: given an amount of money and list of coin denominations, output the 
          number of ways to sum to the amount given the coins available.
    Intuition: This is a dynamic coding problem

    Algorithm:
      - greedily grab from the list and 
    """
