...
def find_second_largest(root_node):
    ...
    """
    Task: find the second largest element in the binary search tree
    Intuition: BFS level order traversal will supply a list of ordered values

    Algorithm: 
      - BFS level order traversal to generate a list of lists
      - take the list[-2][-1] - that is the answer
    """
    queue = deque()
