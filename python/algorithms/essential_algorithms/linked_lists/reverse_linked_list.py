...
def reverse(head_of_list):
    ...
    """
    1. keep track of the previous, current and next node starting from the head
    2. with each step through the linked list point the current node to prev and set the current node to the next
    3. return the prev node, which should now be the head
    """
    prev = None
    curr = head_of_list
